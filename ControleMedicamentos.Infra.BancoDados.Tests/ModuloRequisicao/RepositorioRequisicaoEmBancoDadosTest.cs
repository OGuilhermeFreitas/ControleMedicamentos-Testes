...
namespace ControleMedicamentos.Infra.BancoDados.Tests.ModuloRequisicao
{
    ...
    public class RepositorioRequisicaoEmBancoDadosTest
    {
        ...
        public void Deve_selecionar_todas_requisicoes()
        {
            ...
            Requisicao requisicao1 = new Requisicao(novoMedicamento, novoPaciente, 5, novoFuncionario);
            repositorioRequisicao.Inserir(requisicao1);

            Requisicao requisicao2 = new Requisicao(novoMedicamento, novoPaciente, 6, novoFuncionario);
            repositorioRequisicao.Inserir(requisicao2);

            Requisicao requisicao3 = new Requisicao(novoMedicamento, novoPaciente, 7, novoFuncionario);
            ...
            Assert.AreEqual(requisicao1.Data.Date, requisicoes[0].Data.Date);
            Assert.AreEqual(requisicao2.Data.Date, requisicoes[1].Data.Date);
            Assert.AreEqual(requisicao3.Data.Date, requisicoes[2].Data.Date);
        }
